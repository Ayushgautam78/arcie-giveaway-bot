...
RUMBLE_THEMES = {
    "modern": {
        ...
        "emoji": "🏙️",
        "deaths": [
            "{killer} dropped an unskippable 2-hour video essay directly into {player1}'s AirPods until their head imploded.",
            "{killer} exposed {player1}'s 2016 cringe musical.ly drafts in 4K — {player1} evaporated from second-hand embarrassment.",
            "{killer} ran over {player1} with a hacked Lime scooter cruising at Mach 2 on the sidewalk.",
            "{killer} flashbanged {player1} with Discord Light Mode at 3:00 AM, searing their retinas permanently.",
            "{killer} replaced {player1}'s whey protein powder with dry quick-set cement right before leg day.",
            "{killer} 360-no-scoped {player1} off the high-rise roof in a heated 1v1 on Rust.",
            "{killer} air-dropped a cursed 50GB zip bomb to {player1}'s phone, causing the battery to detonate.",
            "{killer} cancelled {player1} on Twitter with a 47-tweet thread complete with fabricated screenshots.",
            "{killer} trapped {player1} in the IKEA kitchen labyrinth with no exit map; {player1} starved by day 5.",
            "{killer} ordered 40 ghost pepper burritos to {player1}'s address; {player1} perished on the very first bite.",
            "{killer} hacked {player1}'s Tesla on Autopilot and navigated it straight off a scenic cliff.",
            "{killer} disconnected {player1}'s Wi-Fi router on rank-up game point, causing fatal rage-quit cardiac arrest.",
            "{killer} hurled a frozen deep-dish pepperoni pizza like a circular saw blade directly into {player1}'s neck.",
            "{killer} put {player1} on speakerphone in front of their strict parents — instant fatality.",
            "{killer} sniped {player1} from a rooftop with a pressurized Red Bull can cannon.",
            "{killer} roasted {player1}'s outfit so brutally in the voice chat that {player1}'s soul disintegrated.",
            "{killer} locked {player1} in an elevator playing Baby Shark nightcore 10x bass-boosted on infinite repeat.",
            "{killer} tricked {player1} into drinking a whole bottle of Carolina Reaper hot sauce disguised as Prime Energy.",
            "{killer} spammed @everyone in a 100k server and framed {player1}, triggering a mob stampede.",
            "{killer} tackled {player1} off a skyscraper into an empty dumpster while attempting a viral TikTok stunt.",
            "{killer} smacked {player1} in the skull with a cast-iron skillet after {player1} stole the last pizza slice.",
            "{killer} swapped {player1}'s eye drops with industrial super glue right before the duel.",
            "{killer} dropped a 50lb dumbbell directly onto {player1}'s head from the gym pull-up bar.",
            "{killer} unplugged {player1}'s life support in the hospital to plug in their 1% low-battery vape.",
            "{killer} challenged {player1} to a microwave burrito speed-eating race — third-degree internal combustion.",
            "{killer} forced {player1} to listen to an AI crypto podcast for 72 consecutive hours without sleeping.",
            "{killer} smashed a 16-inch MacBook Pro over {player1}'s head after {player1} mocked their Spotify Wrapped.",
            "{killer} tricked {player1} into microwaving aluminum foil inside a porta-potty — MASSIVE EXPLOSION.",
            "{killer} unleashed an autonomous robotic vacuum armed with 3 butcher knives directly at {player1}'s ankles.",
            "{killer} pushed {player1} into the ball pit at Chuck E. Cheese — {player1} sank into the infinite void.",
            "{killer} sent a lethal glitter-bomb kinetic parcel from Amazon straight into {player1}'s face.",
            "{killer} convinced {player1} that umbrellas work as parachutes, and pushed them out of a helicopter.",
            "{killer} shoved {player1} into an open manhole while {player1} was busy catching a Shiny Pokemon.",
            "{killer} fed {player1} a 3-week-old gas station sushi roll, resulting in instant biological failure.",
            "{killer} sprayed {player1} with an entire fire extinguisher at point-blank range.",
            "{killer} challenged {player1} to a bottle flip contest and beaned them in the temple with a frozen hydroflask.",
            "{killer} remotely overclocked {player1}'s gaming PC until the GPU shrapnel pierced their chest.",
            "{killer} tricked {player1} into jumping into a cardboard box labelled 'Free V-Bucks' and threw it into a crusher.",
            "{killer} blindfolded {player1} for a 'bird box challenge' and guided them into oncoming traffic.",
            "{killer} tied {player1} to 500 party balloons and watched them float away into commercial airspace.",
        ],
        "survival": [
            "{player1} found a 100% charged power bank and a secret 5G hotspot to scout enemy positions.",
            "{player1} dodged a lethal ambush thanks to active noise-cancelling AirPods and high reaction speed.",
            "{player1} called an emergency Uber Comfort and safely zipped through the crossfire.",
            "{player1} disguised themselves as a delivery driver with an Amazon Prime vest and slipped away.",
            "{player1} chugged an iced matcha latte and unlocked ultra-instinct parkour reflexes.",
            "{player1} blinded an approaching enemy with a 2,000-lumen ring light and escaped.",
            "{player1} deployed a decoy Wi-Fi network that distracted three enemies while slipping away.",
            "{player1} found a fresh box of glazed donuts in the breakroom and restored full stamina.",
        ],
        "revives": [
            "✨ **CLOUD BACKUP!** **{player1}** restored their life from an automatic iCloud backup and rejoined the battle!",
            "✨ **DEFIBRILLATOR!** Paramedics shocked **{player1}** with 500 volts — **{player1}** is ALIVE and back in the fight!",
            "✨ **COLD BREW REBIRTH!** An emergency IV drip of iced espresso revived **{player1}** back into the arena!",
            "✨ **MICROTRANSACTIONS!** **{player1}** purchased an extra life with Apple Pay and respawned immediately!",
            "✨ **PING ADVANTAGE!** **{player1}** survived a fatal blow because the hit failed to register on 200ms latency!",
        ],
        "phases": [
    ...
    "japanese": {
        ...
        "emoji": "⛩️",
        "deaths": [
            "{killer} teleported behind {player1}, whispered 'Omae wa mou shindeiru', and sliced {player1} in half.",
            "{killer} hit {player1} with Truck-kun at 120 km/h, sending {player1} straight to an isekai fantasy world.",
            "{killer} spent 4 consecutive episodes charging up a Spirit Bomb before hurling it directly into {player1}'s face.",
            "{killer} activated their Mangekyo Sharingan and trapped {player1} in a 72-hour calculus exam genjutsu.",
            "{killer} summoned a 500-meter Kaiju monster that stepped on {player1} like an overripe grape.",
            "{killer} wrote {player1}'s username in the Death Note while dramatically eating a potato chip.",
            "{killer} executed the forbidden Secret Leaf Taijutsu: 1,000 Years of Death on {player1}, launching them into orbit.",
            "{killer} unlocked the unstoppable Power of Friendship and vaporized {player1} with a rainbow laser beam.",
            "{killer} fed {player1} a lethal wasabi dumpling containing 99% pure military-grade chili extract.",
            "{killer} sliced {player1}'s shadow with a folded Damascus katana; {player1} fell apart in slow motion 3 seconds later.",
            "{killer} expanded their Domain: 'Infinite Homework', instantly frying {player1}'s entire nervous system.",
            "{killer} summoned an army of 1,000 Shadow Clones that dog-piled on {player1} at the ramen stall.",
            "{killer} deflected {player1}'s ultimate finishing move with a single chopstick, redirecting it back at {player1}.",
            "{killer} roundhouse kicked {player1} through 14 consecutive traditional Japanese sliding paper doors.",
            "{killer} forced {player1} to watch all 1,100 filler episodes of anime in one sitting with no bathroom breaks.",
            "{killer} drew a legendary cursed blade and sliced {player1} before the sound of the blade unsheathing even played.",
            "{killer} swapped places with a wooden log using substitution jutsu right as {player1} charged into a spike pit.",
            "{killer} struck {player1} with a heavy wooden kendo sword after {player1} insulted their anime waifu.",
            "{killer} opened all Eight Inner Gates and donkey-kicked {player1} straight through the stadium bleachers.",
            "{killer} threw an explosive paper bomb kunai into {player1}'s pocket during an intense 5-minute villain monologue.",
            "{killer} trapped {player1} in a filler beach episode where nothing happened until {player1} perished of sheer boredom.",
            "{killer} challenged {player1} to a samurai duel at sunset and drew their katana at the speed of light.",
            "{killer} piloted a 50-ton Evangelion Mech unit and flattened {player1}'s bunker into metal foil.",
            "{killer} landed an anime punch so powerful it instantly exceeded the animation studio's budget.",
            "{killer} summoned the Nine-Tails Fox Spirit to step on {player1} during morning training roll call.",
            "{killer} poisoned {player1}'s matcha bowl with deadly blowfish fugu toxin during a traditional tea ceremony.",
            "{killer} chanted an ancient forbidden jutsu that summoned a fiery meteorite right on top of {player1}.",
            "{killer} defeated {player1} by playing the protagonist's epic hype theme music in the background.",
            "{killer} challenged {player1} to a ghost pepper ramen eating duel — {player1}'s stomach spontaneously combusted.",
            "{killer} hurled 20 poisoned ninja shurikens into {player1}'s blind spot while running on water.",
            "{killer} placed an enchanted sealing talisman on {player1}'s forehead, turning {player1} into an anime plushie.",
            "{killer} blindfolded {player1} and made them fight an ancient 100-year-old blind master with a broom.",
            "{killer} used a sonic shockwave shout to blast {player1} off the top peak of Mount Fuji.",
            "{killer} locked {player1} in a room filled with 50 enraged wild tanukis.",
            "{killer} threw an explosive smoke bomb that sent {player1} coughing off the canyon cliff.",
        ],
        "survival": [
            "{player1} remembered an emotional childhood flashback and gained a 300% strength boost.",
            "{player1} ate a steaming hot bowl of tonkotsu ramen and fully restored all health and chakra.",
            "{player1} swapped places with a wooden log using substitution jutsu just in the nick of time.",
            "{player1} found a rare glowing Senzu Bean and instantly healed all mortal combat wounds.",
            "{player1} meditated under a freezing mountain waterfall and unlocked ultra sensory awareness.",
            "{player1} disguised themselves as a humble tea merchant and walked past 3 enemy squads.",
            "{player1} caught a flying ninja star out of mid-air between two wooden chopsticks.",
            "{player1} blended seamlessly into a field of blooming cherry blossom petals.",
        ],
        "revives": [
            "✨ **EDO TENSEI!** Dark talisman seals glow — **{player1}** is reanimated from the ashes into battle!",
            "✨ **DRAGON BALLS!** Shenron granted a wish — **{player1}** is brought back to life in the arena!",
            "✨ **PLOT ARMOR!** The anime author gave **{player1}** invincible plot armor — they SURVIVE!",
            "✨ **ISEKAI REVERSE!** **{player1}** rejected the afterlife and respawned right into the fight!",
            "✨ **PHOENIX REBIRTH!** The legendary Suzaku flames ignite — **{player1}** rises anew!",
        ],
        "phases": [
    ...
    "european": {
        ...
        "emoji": "🏰",
        "deaths": [
            "{killer} launched {player1} over the fortress walls with a 90-meter counterweight siege trebuchet.",
            "{killer} beat {player1} to death with a 3-week-old rock-hard stale French baguette.",
            "{killer} unleashed the vicious, fanged Killer Rabbit of Caerbannog upon {player1}.",
            "{killer} coughed the Black Plague directly onto {player1}'s unwashed peasant face.",
            "{killer} dropped a 4-ton iron portcullis onto {player1} as they tried to sprint through the castle gate.",
            "{killer} insulted {player1}'s mother with vicious French mockery until {player1} perished of sheer dishonor.",
            "{killer} challenged {player1} to a 90% proof mead drinking duel; {player1} collapsed into the tavern fireplace.",
            "{killer} poured a cauldron of boiling molten cheese from the battlements straight onto {player1}.",
            "{killer} placed {player1} on the town square guillotine for stealing a single loaf of royal bread.",
            "{killer} ran a 12-foot wooden jousting lance straight through {player1}'s steel breastplate at full gallop.",
            "{killer} struck {player1} with a spiked iron morningstar flail right through their steel plate helmet.",
            "{killer} pushed {player1} into the castle moat infested with hungry carnivorous leeches and giant pikes.",
            "{killer} convinced the royal church tribunal that {player1} was a witch because {player1} floated on water.",
            "{killer} locked {player1} inside the castle dungeon's Iron Maiden and tossed the iron key into the river.",
            "{killer} shot an English longbow broadhead arrow through an arrow slit straight through {player1}'s eye socket.",
            "{killer} pushed {player1} into a giant wooden vat of fermenting elderberry wine — drowned in vintage luxury.",
            "{killer} slapped {player1} with an iron gauntlet to initiate a duel, then pulled a hidden crossbow.",
            "{killer} dropped the cathedral's 2-ton bronze bell from the bell tower directly onto {player1}.",
            "{killer} fed {player1} to the royal dungeon dragon after claiming it was a friendly oversized garden lizard.",
            "{killer} banished {player1} into the dark Bavarian forest inhabited by a pack of hungry werewolves.",
            "{killer} set fire to {player1}'s thatch-roof peasant cottage while {player1} was asleep in full armor.",
            "{killer} tricked {player1} into pulling a fake sword from a stone, triggering a boulder avalanche on {player1}.",
            "{killer} challenged {player1} to a duel and chopped off all 4 limbs while screaming ''TIS BUT A SCRATCH!'.",
            "{killer} shoved {player1} down the castle's 400-step spiral stone staircase in clanking full plate armor.",
            "{killer} poisoned {player1}'s golden goblet of royal wine with deadly hemlock and swamp toad venom.",
            "{killer} trampled {player1} under the iron hooves of a 2,000lb armored Clydesdale warhorse.",
            "{killer} catapulted a diseased wooden cart filled with rotten cabbage straight into {player1}'s tent.",
            "{killer} dropped an iron anvil from the castle ramparts on {player1} like a classic cartoon knight.",
            "{killer} pushed {player1} into the castle latrine ditch after {player1} made a joke about the King's hairline.",
            "{killer} hired three Venetian assassins who ambushed {player1} behind the royal blacksmith.",
            "{killer} tied {player1} to the blade of a medieval windmill during a fierce gale.",
            "{killer} challenged {player1} to a royal fencing match and skewered them through their velvet cape.",
            "{killer} convinced the town mob that {player1} stole the holy grail, resulting in an angry pitchfork riot.",
            "{killer} dropped a cage of rabid castle dungeon rats directly onto {player1}.",
            "{killer} challenged {player1} to eat the royal court jester's mystery stew — died of 14th century botulism.",
        ],
        "survival": [
            "{player1} found the Holy Hand Grenade of Antioch and kept all encroaching knights at bay.",
            "{player1} took refuge in the tavern wine cellar with three casks of fine elderberry mead.",
            "{player1} shielded themselves with a solid 40lb wheel of 5-year aged parmesan cheese.",
            "{player1} produced a royal pardon sealed by the King's signet ring, halting an execution.",
            "{player1} discovered a secret underground tunnel connecting the dungeon to safety.",
            "{player1} donned a legendary suit of gilded knight armor with +50 fortification.",
            "{player1} found a giant roasted turkey leg in the banquet hall and restored full vigor.",
            "{player1} bribed the castle guards with a heavy velvet pouch of shiny silver florins.",
        ],
        "revives": [
            "✨ **'TIS BUT A SCRATCH!** **{player1}** stood right back up! Just a flesh wound!",
            "✨ **HOLY BLESSING!** The Archbishop cast a miraculous resurrection prayer — **{player1}** lives!",
            "✨ **ALCHEMIST ELIXIR!** The royal court alchemist poured philosopher's stone liquid on **{player1}**!",
            "✨ **DIVINE INTERVENTION!** Saint George intervened from the heavens — **{player1}** rises anew!",
            "✨ **ROYAL DECREE!** The King decrees that **{player1}** is NOT permitted to perish yet!",
        ],
        "phases": [
    ...
    "web3_ancient": {
        ...
        "emoji": "🏛️",
        "deaths": [
            "{killer} rug-pulled {player1}'s entire liquidity pool, instantly reducing {player1}'s market cap to $0.00.",
            "{killer} fed {player1} to the Roman Colosseum lions for the afternoon entertainment of Emperor Caesar.",
            "{killer} liquidated {player1}'s 125x leveraged Bitcoin long position with a single 1-minute red wick.",
            "{killer} flash-loan attacked {player1}'s smart contract and drained their entire life essence in one block.",
            "{killer} impaled {player1} with a golden gladiator trident and kicked them into the arena fire pit.",
            "{killer} sent a malicious transaction to {player1}'s MetaMask, draining both their life savings and their soul.",
            "{killer} tricked {player1} into aping their life savings into a fake Telegram dev presale token — dead on arrival.",
            "{killer} struck {player1} with Zeus's golden thunderbolt summoned from the peak of Mount Olympus.",
            "{killer} sandwiched {player1}'s DEX swap with MEV sniper bots, vaporizing {player1} from the blockchain.",
            "{killer} threw {player1} off a supersonic Roman chariot right into the spiked arena perimeter wall.",
            "{killer} fed {player1} to the mythical Minotaur dwelling at the center of the subterranean labyrinth.",
            "{killer} hacked the cross-chain bridge {player1} was crossing, sending {player1} plunging into the void.",
            "{killer} posted {player1}'s 24-word private seed phrase on a billboard in downtown Ancient Rome.",
            "{killer} smashed {player1} with a heavy Spartan bronze hoplite shield during a full-speed shield bash charge.",
            "{killer} executed a 51% hash-rate attack on {player1}'s brainwaves, reorganizing their reality.",
            "{killer} minted {player1} as a worthless zero-volume NFT and sent it to a dead burner address.",
            "{killer} pushed {player1} into a gladiatorial snake pit after {player1} refused to pay 500 gwei gas fees.",
            "{killer} slashed {player1}'s validator stake for double-signing, wiping them out of the consensus layer.",
            "{killer} challenged {player1} to a chariot race and spiked {player1}'s wooden wheels with iron caltrops.",
            "{killer} convinced {player1} that a shady Telegram crypto dev from Dubai was going to make them rich.",
            "{killer} stabbed {player1} through the armor gap with a poisoned Spartan gladius sword.",
            "{killer} trapped {player1} in an un-audited DeFi yield farm with a 100% deposit fee and no withdrawal function.",
            "{killer} made Emperor Caesar give a giant thumbs down to {player1}, summoning 10 gladiators with spears.",
            "{killer} shorted Ethereum right as {player1} went all-in on 100x leverage at the absolute top.",
            "{killer} threw {player1} into the boiling magma pit beneath Mount Vesuvius.",
            "{killer} tricked {player1} into signing a malicious 'Permit2' transaction on a phishing mirror.",
            "{killer} dropped a 3-ton marble Roman pillar of Jupiter directly on top of {player1}.",
            "{killer} unleashed 50 hungry war hounds after {player1} across the blood-soaked arena sands.",
            "{killer} hacked {player1}'s Telegram and drained their OTC escrow funds, causing fatal heartbreak.",
            "{killer} hit {player1} with a flaming catapult pitch ball during the opening gladiator ceremonies.",
            "{killer} convinced {player1} to store their private keys on a public Discord screenshot.",
            "{killer} challenged {player1} to wrestle a Spartan warrior while {player1} was wearing flip-flops.",
            "{killer} offered {player1} an ancient Roman fermented fish sauce potion that was 2,000 years expired.",
            "{killer} paper-handed {player1}'s favorite token so hard that {player1} died of sheer emotional agony.",
            "{killer} summoned Medusa to make direct eye contact with {player1} while {player1} was checking DexScreener.",
        ],
        "survival": [
            "{player1} held with DIAMOND HANDS 💎 through the market crash and emerged completely unscathed.",
            "{player1} was protected by the golden aegis shield of Athena.",
            "{player1} locked their vital essence inside a cold storage Ledger hardware wallet in a bunker.",
            "{player1} received an unexpected 100,000 token airdrop from a benevolent ancient crypto whale.",
            "{player1} took shelter in the VIP royal box with Emperor Caesar and sipped nectar.",
            "{player1} found a legendary Spartan spear buried beneath the bloody arena sand.",
            "{player1} was blessed by Hermes with winged sandals for maximum evasion agility.",
            "{player1} diversified into ancient physical gold and survived the chaotic storm.",
        ],
        "revives": [
            "✨ **HARD FORK!** The blockchain state was rolled back — **{player1}** is RESTORED to life!",
            "✨ **LAZARUS PROTOCOL!** **{player1}** executed an autonomous smart recovery contract and lives!",
            "✨ **BUY THE DIP!** **{player1}** bought their own liquidations and surged back into the arena!",
            "✨ **OLYMPUS BLESSING!** Zeus cast a spark of eternal divine fire — **{player1}** is REBORN!",
            "✨ **WHALE AIRDROP!** An anonymous whale funded **{player1}**'s immediate resurrection!",
        ],
        "phases": [
...
class RumbleGame:
    ...
    def _kill_player(self, victim: dict, killer: Optional[dict] = None) -> str:
        """Eliminate a player and return the event text with strikethrough for victim."""
        ...
        if killer:
            ...
            text = template.format(player1=v_display, killer=k_display, victim=v_display, player2=v_display)
        else:
            self.eliminated_by[victim["id"]] = "The Arena"
            text = template.format(player1=v_display, killer="**The Arena**", victim=v_display, player2=v_display)
